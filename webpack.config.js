...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "src/scss/styles.scss")
        ],
        "test": /\.css$/,
        "loaders": [
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      ...
      "globOptions": {
        "cwd": "/Users/leoliu/angular/employee-hierarchy-client/src",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
      ...
      patterns: [
          {
              ...
              replacement: function (match) {
                  return process.env.CURRENT_ENV ? process.env.CURRENT_ENV : 'local';
              }
          },
      ]
    })
